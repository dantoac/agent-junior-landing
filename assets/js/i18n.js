...
(function () {
  ...
  var translations = {
    en: {
      ...
      "features.tasks.desc": "Create, organize, and track tasks with subtasks, labels, and team assignments. Auto-complete parent tasks when all subtasks are done.",
      ...
      "features.files.desc": "Parse PDFs, spreadsheets, documents, and analyze images with OCR. Extract data from receipts, diagrams, and photos.",
      ...
      "why.curated.desc": "Every tool vetted. Every integration tested. 9 specialized agents plus a curated Skills Marketplace — quality over 3,000 unvetted community plugins.",
      ...
      "pricing.starter.f2": "Files Agent (PDF, spreadsheets, images)",
      ...
      "pricing.pro.f4": "RSS Agent",
      "pricing.pro.f5": "Skills Marketplace",
      "pricing.pro.f6": "11 Agent Templates",
      ...
      "pricing.ultimate.f3": "Custom agents & prompts",
      "pricing.ultimate.f4": "Scheduled jobs & automation",
      "pricing.ultimate.f5": "Webhooks API",
      "pricing.ultimate.f6": "Task assignees & collaboration",
      ...
      "faq.features.4.q": "What are Agent Templates?",
      "faq.features.4.a": "Agent Templates are pre-configured agents for specific workflows. Choose from 11 templates like Meeting Assistant, Sales Outreach, Weekly Digest, GitHub Triage, and more. Each template comes with optimized prompts and tool configurations. Available on Pro and Ultimate tiers.",
      "faq.features.5.q": "How do notifications work?",
      "faq.features.5.a": "AgenticJunior sends notifications via Telegram and email for task reminders, scheduled jobs, inbound emails, and GitHub events. Configure quiet hours, choose per-notification-type channels, and set default reminder times. Your preferences are fully customizable from the settings page.",
      "faq.features.6.q": "Can AgenticJunior analyze images?",
      "faq.features.6.a": "Yes. Send images via Telegram or the web dashboard and AgenticJunior can perform OCR, analyze receipts, read diagrams, and extract text from photos. Images are processed in memory and never stored \u2014 they are ephemeral for your privacy.",
      "faq.templates.q": "What are Agent Templates?",
      "faq.templates.a": "Agent Templates are pre-configured agents for specific workflows. Choose from 11 templates like Meeting Assistant, Sales Outreach, Weekly Digest, GitHub Triage, and more. Each template comes with optimized prompts and tool configurations. Available on Pro and Ultimate tiers.",
      "faq.notifications.q": "How do notifications work?",
      "faq.notifications.a": "AgenticJunior sends notifications via Telegram and email for task reminders, scheduled jobs, inbound emails, and GitHub events. Configure quiet hours, choose per-notification-type channels, and set default reminder times. Your preferences are fully customizable from the settings page.",
      "faq.images.q": "Can AgenticJunior analyze images?",
      "faq.images.a": "Yes. Send images via Telegram or the web dashboard and AgenticJunior can perform OCR, analyze receipts, read diagrams, and extract text from photos. Images are processed in memory and never stored \u2014 they are ephemeral for your privacy.",
    ...
    es: {
      ...
      // -- Features --
      "features.headline": "Nueve agentes.",
      ...
      "features.tasks.desc": "Crea, organiza y gestiona tareas con subtareas, etiquetas y asignaciones de equipo. Auto-completa tareas padres cuando todas las subtareas terminan.",
      ...
      "features.files.desc": "Analiza PDFs, hojas de c\u00e1lculo, documentos e im\u00e1genes con OCR. Extrae datos de recibos, diagramas y fotos.",
      ...
      "why.curated.desc": "Cada herramienta verificada. Cada integraci\u00f3n probada. 9 agentes especializados m\u00e1s un Skills Marketplace curado — calidad sobre 3,000 plugins sin verificar.",
      ...
      "pricing.starter.f2": "Agente de Archivos (PDF, hojas de c\u00e1lculo, im\u00e1genes)",
      "pricing.starter.f3": "Web + Telegram",
      ...
      "pricing.pro.f4": "Agente RSS",
      "pricing.pro.f5": "Skills Marketplace",
      "pricing.pro.f6": "11 Plantillas de Agentes",
      "pricing.ultimate.title": "Ultimate",
      "pricing.ultimate.subtitle": "Poder total",
      "pricing.ultimate.f1": "Todo en Pro",
      "pricing.ultimate.f2": "Agente Creador de Contenido",
      "pricing.ultimate.f3": "Agentes y prompts personalizados",
      "pricing.ultimate.f4": "Trabajos programados y automatizaci\u00f3n",
      "pricing.ultimate.f5": "API de Webhooks",
      "pricing.ultimate.f6": "Asignaci\u00f3n de tareas y colaboraci\u00f3n",
      ...
      "faq.features.4.q": "\u00bfQu\u00e9 son las Plantillas de Agentes?",
      "faq.features.4.a": "Las Plantillas de Agentes son agentes pre-configurados para flujos de trabajo espec\u00edficos. Elige entre 11 plantillas como Asistente de Reuniones, Prospector de Ventas, Resumen Semanal, Triaje de GitHub, y m\u00e1s. Cada plantilla viene con prompts optimizados y configuraciones de herramientas. Disponible en los tiers Pro y Ultimate.",
      "faq.features.5.q": "\u00bfC\u00f3mo funcionan las notificaciones?",
      "faq.features.5.a": "AgenticJunior env\u00eda notificaciones v\u00eda Telegram y email para recordatorios de tareas, trabajos programados, emails entrantes y eventos de GitHub. Configura horas de silencio, elige canales por tipo de notificaci\u00f3n y establece tiempos de recordatorio predeterminados. Tus preferencias son completamente configurables desde la p\u00e1gina de ajustes.",
      "faq.features.6.q": "\u00bfPuede AgenticJunior analizar im\u00e1genes?",
      "faq.features.6.a": "S\u00ed. Env\u00eda im\u00e1genes v\u00eda Telegram o el panel web y AgenticJunior puede realizar OCR, analizar recibos, leer diagramas y extraer texto de fotos. Las im\u00e1genes se procesan en memoria y nunca se almacenan \u2014 son ef\u00edmeras para tu privacidad.",
      "faq.templates.q": "\u00bfQu\u00e9 son las Plantillas de Agentes?",
      "faq.templates.a": "Las Plantillas de Agentes son agentes pre-configurados para flujos de trabajo espec\u00edficos. Elige entre 11 plantillas como Asistente de Reuniones, Prospector de Ventas, Resumen Semanal, Triaje de GitHub, y m\u00e1s. Cada plantilla viene con prompts optimizados y configuraciones de herramientas. Disponible en los tiers Pro y Ultimate.",
      "faq.notifications.q": "\u00bfC\u00f3mo funcionan las notificaciones?",
      "faq.notifications.a": "AgenticJunior env\u00eda notificaciones v\u00eda Telegram y email para recordatorios de tareas, trabajos programados, emails entrantes y eventos de GitHub. Configura horas de silencio, elige canales por tipo de notificaci\u00f3n y establece tiempos de recordatorio predeterminados. Tus preferencias son completamente configurables desde la p\u00e1gina de ajustes.",
      "faq.images.q": "\u00bfPuede AgenticJunior analizar im\u00e1genes?",
      "faq.images.a": "S\u00ed. Env\u00eda im\u00e1genes v\u00eda Telegram o el panel web y AgenticJunior puede realizar OCR, analizar recibos, leer diagramas y extraer texto de fotos. Las im\u00e1genes se procesan en memoria y nunca se almacenan \u2014 son ef\u00edmeras para tu privacidad.",
